      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {topics.map((topic) => (
            <button
              key={topic}
              className="group relative px-8 py-4 rounded-full bg-light border-2 border-[#E2E8FB] hover:border-[#6D8EEC] transition-all duration-300 hover:shadow-[0_8px_24px_-8px_rgba(109,142,236,0.2)]"
            >
