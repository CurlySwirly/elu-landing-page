      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3" style={{ fontFamily: 'Open Sans, sans-serif' }}>
              <li><a href={PATHS.impressum} className={linkClass}>Impressum</a></li>
              <li><a href={PATHS.datenschutz} className={linkClass}>Datenschutz</a></li>
              <li><a href={PATHS.nutzungsbedingungen} className={linkClass}>Nutzungsbedingungen</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3" style={{ fontFamily: 'Open Sans, sans-serif' }}>
              <li><a href={PATHS['ueber-uns']} className={linkClass}>Über uns</a></li>
              <li><a href={PATHS.support} className={linkClass}>Kontakt &amp; Support</a></li>
              <li><a href={PATHS.blog} className={linkClass}>Blog</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-600 mt-12 pt-8 text-center">
          <p className="text-gray-400" style={{ fontFamily: 'Open Sans, sans-serif' }}>
            © {new Date().getFullYear()} <span className="font-bold">elu.</span> <span className="font-extralight italic">elevate you</span>. Alle Rechte vorbehalten.
          </p>
        </div>
      </div>
    </footer>
